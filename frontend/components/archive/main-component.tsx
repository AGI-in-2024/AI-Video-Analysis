...
import { Upload, FileText, Image, MessageSquare, Layers, Wand2, Settings, Download, Share2 } from "lucide-react"
...
const mockAnalysisResults = {
  "00:00:10": [{ class: "person", confidence: 0.95 }, { class: "car", confidence: 0.87 }],
  "00:00:20": [{ class: "building", confidence: 0.92 }, { class: "tree", confidence: 0.89 }],
}

const mockOcrResults = {
  "00:00:10": "Газпром Медиа",
  "00:00:20": "Инновации в медиа",
}

const mockTranscriptionResults = "Добро пожаловать в мир Газпром Медиа. Мы создаем инновационные решения для медиа индустрии..."
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (isTesterMode) {
      ...
      setTimeout(() => {
        ...
        setTranscriptionResults(mockTranscriptionResults)
  ...
  return (
    <NextThemesProvider attribute="class" defaultTheme="dark" enableSystem>
      <div className="container mx-auto p-4 max-w-6xl bg-background text-foreground">
        ...
        <div className="mb-4">
          <Label htmlFor="tester-mode">Тестовый режим</Label>
          <Switch
            id="tester-mode"
            checked={isTesterMode}
            onCheckedChange={setIsTesterMode}
          />
        </div>
...
ите возможность использования сегмента 02:15-03:00 для промо-материалов.</p>
            </div>
          </DialogContent>
        </Dialog>
          ...
          <Dialog open={showReport} onOpenChange={setShowReport}>
            <DialogContent className="max-w-4xl">
              ...
              <div className="mt-4 space-y-4">
                ...
                <ul className="list-disc list-inside">
                  <li>Длительность видео: {/* Duration will be provided by VideoPlayer */} секунд</li>
                  ...
                  <li>Количество кадров с текстом: {Object.keys(ocrResults || {}).length}</li>
                </ul>
                <h3 className="text-lg font-semibold">Распределение объектов:</h3>
                {/* Add a chart or table showing object distribution */}
        ...
        <Dialog open={showSettings} onOpenChange={setShowSettings}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Выберите модели и параметры для каждого типа анализа.
              </DialogDescription>
            </DialogHeader>
